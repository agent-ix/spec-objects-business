...
- The `enumeration`, `domain`, `state_machine`, `process`, and `aggregate_root` skeletons SHALL author their model sections (`## Values`, `## Ubiquitous Language`, `## States`, `## Transitions`, `## Workflow`, `## Members`) as the FR-006 model tables and nothing else.
